...
class ScanditBarcodeCapture :
    ...
    @PluginMethod
    fun setFindViewPositionAndSize(args: JSONArray, callbackContext: CallbackContext) {
    ...
    fun setAimedBarcodeBrushProvider(
        ...
        barcodeSelectionModule.setAimedBarcodeBrushProvider(CordovaResultKeepCallback(callbackContext))
    }
    ...
    fun setTrackedBarcodeBrushProvider(
        ...
        barcodeSelectionModule.setTrackedBarcodeBrushProvider(CordovaResultKeepCallback(callbackContext))
    }
    ...
    @PluginMethod
    fun finishBarcodeCountViewListenerOnBrushForUnrecognizedBarcode(
        args: JSONArray,
        callbackContext: CallbackContext
    ) {
        val payload = args.getJSONObject(0)
