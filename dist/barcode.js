...
class BarcodeCountListenerController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.BarcodeCountListenerEvents.didScan, (body) => __awaiter(this, void 0, void 0, function* () {
...
class BarcodeCaptureListenerController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.BarcodeCaptureListenerEvents.didUpdateSession, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
        ...
        this.eventEmitter.on(exports.BarcodeCaptureListenerEvents.didScan, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
            const session = BarcodeCaptureSession.fromJSON(payload);
...
class BarcodeSelectionListenerController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.BarcodeSelectionListenerEvents.didUpdateSelection, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
        ...
        this.eventEmitter.on(exports.BarcodeSelectionListenerEvents.didUpdateSession, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
            const session = BarcodeSelectionSession.fromJSON(payload);
            session.listenerController = this;
            yield this.notifyListenersOfDidUpdateSession(session);
...
class BarcodeBatchListenerController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.BarcodeBatchListenerEvents.didUpdateSession, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
...
class BarcodeBatchAdvancedOverlayController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.BarcodeBatchAdvancedOverlayListenerEvents.viewForTrackedBarcode, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
        ...
        this.eventEmitter.on(exports.BarcodeBatchAdvancedOverlayListenerEvents.anchorForTrackedBarcode, (body) => {
            const payload = JSON.parse(body);
            const trackedBarcode = TrackedBarcode
                .fromJSON(JSON.parse(payload.trackedBarcode));
        ...
        this.eventEmitter.on(exports.BarcodeBatchAdvancedOverlayListenerEvents.offsetForTrackedBarcode, (body) => {
            const payload = JSON.parse(body);
            const trackedBarcode = TrackedBarcode
                .fromJSON(JSON.parse(payload.trackedBarcode));
        ...
        this.eventEmitter.on(exports.BarcodeBatchAdvancedOverlayListenerEvents.didTapViewForTrackedBarcode, (body) => {
            var _a, _b;
            const payload = JSON.parse(body);
            const trackedBarcode = TrackedBarcode
                .fromJSON(JSON.parse(payload.trackedBarcode));
...
class BarcodeBatchBasicOverlayController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.BarcodeBatchBasicOverlayListenerEvents.brushForTrackedBarcode, (body) => {
            const payload = JSON.parse(body);
            const trackedBarcode = TrackedBarcode
                .fromJSON(JSON.parse(payload.trackedBarcode));
        ...
        this.eventEmitter.on(exports.BarcodeBatchBasicOverlayListenerEvents.didTapTrackedBarcode, (body) => {
            const payload = JSON.parse(body);
            const trackedBarcode = TrackedBarcode
                .fromJSON(JSON.parse(payload.trackedBarcode));
...
class SparkScanListenerController extends scanditDatacaptureFrameworksCore.BaseController {
    ...
    subscribeListener() {
        ...
        this.eventEmitter.on(exports.SparkScanListenerEvents.didUpdateSession, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
            const session = SparkScanSession.fromJSON(payload);
            yield this.notifyListenersOfDidUpdateSession(session);
            this._proxy.finishDidUpdateSessionCallback(this.sparkScan.isEnabled);
        }));
        this.eventEmitter.on(exports.SparkScanListenerEvents.didScan, (body) => __awaiter(this, void 0, void 0, function* () {
            const payload = JSON.parse(body);
            const session = SparkScanSession.fromJSON(payload);
            yield this.notifyListenersOfDidScan(session);
...
class SparkScanViewController extends scanditDatacaptureFrameworksCore.BaseController {
    ...
    subscribeListeners() {
        ...
        this.eventEmitter.on(exports.SparkScanViewEvents.barcodeFindButtonTapped, () => {
            var _a, _b;
            (_b = (_a = this.view.uiListener) === null || _a === void 0 ? void 0 : _a.didTapBarcodeFindButton) === null || _b === void 0 ? void 0 : _b.call(_a, this.view);
        });
        this.eventEmitter.on(exports.SparkScanViewEvents.didChangeViewState, (newState) => {
            var _a, _b;
    ...
    unsubscribeListeners() {
        ...
        this.eventEmitter.off(exports.SparkScanViewEvents.barcodeFindButtonTapped);
    }
    create() {
        const viewJson = {
